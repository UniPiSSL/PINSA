...
class IndyPresExchHandler:
    ...
    async def return_presentation(
        ...
        #print("pres_exch_hanlder.py | return_presentation() | Called by " + inspect.stack()[1][3] + " \n")     #good
        #print("pres_exch_hanlder.py | return_presentation() | POINT 0 ----------\n")                           #good

        myString = str(pres_ex_record)

        #print("PRES_EX_ID--> " + myString[22:58])
        #print("REQUESTED_CREDENTIALS--> " + str(requested_credentials))
        
        holder = self._profile.inject(IndyHolder)
        credentials = {}

        #print("pres_exch_hanlder.py | return_presentation() | POINT 1 ----------\n")                          #good
        #print("CREDENTIALS--> " + str(credentials))                                                           #good
        ...
        #print("pres_exch_hanlder.py | return_presentation() | POINT 2 ----------\n")                          #good  
        #print("CREDENTIALS--> " + str(credentials))
        #print("PROOF_REQUEST--> " + str(proof_request))
        ...
        #print("pres_exch_hanlder.py | return_presentation() | POINT 3 ----------\n")                          #good
        #print("3. CREDENTIALS--> " + str(credentials))                                                        #good
        ...
        #print("pres_exch_hanlder.py | return_presentation() | POINT 4 ----------\n")                        #good
        #print("4. CREDENTIALS--> " + str(credentials))                                                      #good
        ...
        #print("pres_exch_hanlder.py | return_presentation() | POINT 5 ----------\n")                       #good
        #print("5. CREDENTIALS--> " + str(credentials))                                                     #good
        ...
        #print("pres_exch_hanlder.py | return_presentation() | POINT 6 ----------\n")                       #good
        #print("6. CREDENTIALS-> " +  str(credentials))                                                     #good
        ...
        #print("pres_exch_hanlder.py | return_presentation() | call holder.create_presentation() - BEFORE \n")        #good
        ...
        #print("pres_exch_hanlder.py | return_presentation() | call holder.create_presentation() - AFTER \n")         #good
