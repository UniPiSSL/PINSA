...
class V20PresRequestHandler(BaseHandler):
    ...
    async def handle(self, context: RequestContext, responder: BaseResponder):
        ...
        #print("pres_request_handler.py | CONTEXT = " + str(context.message))      #good
        ...
        #print("pres_request_handler.py | Handling PRES_EX_RECORD: " + str(pres_ex_record))

        # If auto_present is enabled, respond immediately with presentation
        if pres_ex_record.auto_present:
            pres_message = None
            #print("pres_request_handler.py | pres_ex_record.pres_ex_id = " + pres_ex_record.pres_ex_id)
            try:
