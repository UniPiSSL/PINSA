...
class IndyPresExchangeHandler(V20PresFormatHandler):
    ...
    async def create_pres(
        ...
        #print("handler.py | create_pres() | request_data = " + str(request_data) + " \n")      #good
        ...
        '''
        print("handler.py | create_pres() | HERE | prin kalestei i return_presentation()\n")
        print(f"handler.py | create_pres() | pres_ex_record = {str(pres_ex_record)} | requested_credentials = {str(requested_credentials)} ") 
        print(f"handler.py | create_pres() | requested_credentials = {str(requested_credentials)} ") 
        try:
            indy_proof = await indy_handler.return_presentation(
                pres_ex_record=pres_ex_record,
                requested_credentials=requested_credentials,
            ...
            print("handler.py | create_pres() |  EXCEPTION = " + str(e) + " \n")

        print("handler.py | create_pres() | END \n")
        '''
