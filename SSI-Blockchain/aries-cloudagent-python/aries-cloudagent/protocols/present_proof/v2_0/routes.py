...
async def present_proof_list(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_list()  ------------------")        #good
...
async def present_proof_retrieve(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_retrieve()  ------------------")       #good
...
async def present_proof_credentials_list(request: web.BaseRequest):
    ...
    randomID = uuid.uuid4().int

    #print("-------------- API = present_proof_credentials_list()  ------------------")

    #print("routers.py | API | present_proof_credentials_list() | " + str(randomID) + " | REQUEST = " + str(request) + " " + str(int(time.time())) )   #good
    #<Request GET /present-proof-2.0/records/2eaf8631-5341-4683-af3d-666195ab4cc4/credentials >
    ...
    #print("routes.py | pres_ex_id = " + pres_ex_id)
    #print("routes.py | referents = " + str(referents))
    #print("routes.py | pres_referents = " + str(pres_referents))
    ...
    try:
        ...
        if indy_pres_request:
            #print("routes.py | INDY_CREDENTIALS (p1)= " + str(indy_credentials))
            indy_credentials = (
    ...
    #print("routes.py | INDY_CREDENTIALS (p2) = " + str(indy_credentials))
    ...
    #print("routers.py | API | present_proof_credentials_list() | " + str(randomID) + " | ReturnJson = " + str(credentials))    #good
...
async def present_proof_create_request(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_create_request()  ------------------")    #good
...
async def present_proof_send_free_request(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_send_free_request()  ------------------")      #good
...
async def present_proof_send_bound_request(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_send_bound_request()  ------------------")     #good
...
async def present_proof_send_presentation(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_send_presentation()  routes.py ------------------")
    #print("routers.py | present_proof_send_presentation() | start")                                    #good
    ...
    #print("routers.py | BODY = " + str(body))       #good
    ...
    #print("routers.py | present_proof_send_presentation() | result = " + str(result))          #good
    #print("routers.py | present_proof_send_presentation() | end")                              #good
...
async def present_proof_verify_presentation(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_verify_presentation()  ------------------")      #good
...
async def present_proof_problem_report(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_problem_report()  ------------------")       #good
...
async def present_proof_remove(request: web.BaseRequest):
    ...
    #print("-------------- API = present_proof_remove()  ------------------")       #good
