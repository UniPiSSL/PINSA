...
class IndyCredxHolder(IndyHolder):
    ...
    async def get_credentials_for_presentation_request_by_referent(
        ...
        #print("indy/credx/holder.py | " +  str(randomID) + " | presentation_request = " + str(presentation_request)) 

        #print("indy/credx/holder.py | " +  str(randomID) + " | Length of referents = " + str(len(referents)))
        #for ref in referents:
        #    counter = 1
        #    print("indy/credx/holder.py | " +  str(randomID) + " | ref" + str(counter) + "= " + ref) 
        #    counter = counter + 1    

        if not referents:
            #print("indy/credx/holder.py | " +  str(randomID) + " | mpikes edo pera diladi not referents")
            referents = (
        ...
        #print("indy/credx/holder.py | " +  str(randomID) + " | referents = " + str(referents))
        ...
        for reft in referents:
            ...
            #print("indy/credx/holder.py |  " +  str(randomID) + " | tag_filter = " + str(tag_filter))
        ...
        #print("indy/credx/holder.py | get_credentials_for_presentation_request_by_referent | RETURN = " + str(list(creds.values())))
        
        #myList = list(creds.values())
        #for item in myList:
        #    ind = 0
        #    print("indy/credx/holder.py | " +  str(randomID) + " | Item = " + str(ind) + " " + str(item))
        #    ind = ind + 1
    ...
    async def create_presentation(
        ...
        #print("holder.py | create_presentation() | start\n")                                   #good

        #print("holder.py | CREDENTIAL_DEFINITIONS = " + str(credential_definitions) + "\n")
        ...
        try:
            ...
            secret = await self.get_master_secret()
            #print("holder.py | SECRET = " + str(secret) + "\n")                                                    #good

            #print("holder.py | CREDENTIAL_DEFINITIONS = " + str(credential_definitions) + "\n")
            #print("holder.py | CREDENTIAL_DEFINITIONS_VALUES= " + str(credential_definitions.values()) + "\n")
            ...
            raise IndyHolderError("Error GP creating presentation - raise") from err
            #print("holder.py | ERROR GP creating presentation - MYprint")

        #print("holder.py | create_presentation() | RETURN = " + str(presentation.to_json()))

        #print("holder.py | create_presentation() | end\n")         #good
